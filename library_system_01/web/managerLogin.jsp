...
<body>
    <form method="post" action="<c:url context='${pageContext.request.contextPath}' value='/manager/managerlogin.jsp'/>">
        <div class="login-panel">
            <div class="inner-wrap">
                <!--                <div id="user-name-label">-->
                管理员：<input type="text" name="username" value="root" id="search" > <br/>
                <!--                </div>-->
                密&emsp;码：<input type="password" name="password" value="root" ><br/>
